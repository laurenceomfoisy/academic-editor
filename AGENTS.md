...
- create child beads for specialist workstreams
- claim and update beads as work progresses
- use `bd ready` to decide the next unblocked task

`academic-writer` is expected to use `bd` as its workflow memory backbone.
